...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            [
                'name' => 'viewAny calendar event',
                'guard_name' => 'web',
                'description' => 'L\'utilisateur peut voir les évènements de calendrier.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'guard_name' => 'web',
                'description' => 'L\'utilisateur peut voir un évènement des calendriers.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'guard_name' => 'web',
                'description' => 'L\'utilisateur peut créer un évènement de calendrier.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'guard_name' => 'web',
                'description' => 'L\'utilisateur peut mettre à jour un évènement de calendrier.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'guard_name' => 'web',
                'description' => 'L\'utilisateur peut supprimer un évènement de calendrier.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'guard_name' => 'web',
                'description' => 'L\'utilisateur peut rechercher des évènements de calendrier.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
