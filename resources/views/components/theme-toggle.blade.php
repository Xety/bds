<button x-data="{
                toggle: () => {
                    if (localStorage.theme === 'dark') {
                        ...
                        document.getElementById('flatpickrCssFile').href = '{{ asset('/assets/flatpickr_default.css') }}';
                    } else {
        ...
        @click="toggle"
        type="button" class="relative inline-flex flex-shrink-0 h-6 mx-5 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer bg-zinc-200 dark:bg-base-100 w-11 focus:outline-none focus:ring-2 focus:ring-neutral-700 focus:ring-offset-2" role="switch" aria-checked="false">
