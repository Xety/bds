...
enum EnsachageType: string
{
    ...
    {
        return match ($this) {
            EnsachageType::Sacs => 'Sacs',
            EnsachageType::Big_Bag => 'Big-Bag',
            EnsachageType::Non_Applicable => 'Non-Applicable',
        };
    }
    ...
    public static function toSelectArray(): array
    {
        ...
        foreach (EnsachageType::cases() as $case) {
            $array[] = [
                'id' => $case->value,
                'name' => $case->label(),
            ];
